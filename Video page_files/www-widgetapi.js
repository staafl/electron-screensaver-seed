...
return this})},a)}
r.getVideoEmbedCode=function(){var a=parseInt(Q(this.g,"width"),10),b=parseInt(Q(this.g,"height"),10),c=Q(this.g,"host")+this.G();Ya.test(c)&&(-1!=c.indexOf("&")&&(c=c.replace(Sa,"&amp;")),-1!=c.indexOf("<")&&(c=c.replace(Ta,"&lt;")),-1!=c.indexOf(">")&&(c=c.replace(Ua,"&gt;")),-1!=c.indexOf('"')&&(c=c.replace(Va,"&quot;")),-1!=c.indexOf("'")&&(c=c.replace(Wa,"&#39;")),-1!=c.indexOf("\x00")&&(c=c.replace(Xa,"&#0;")));return'<iframe width="'+a+'" height="'+b+'" src="'+c+'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'};
